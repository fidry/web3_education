...
class Currency(ReprWithoutData):
    ...
    def __init__(self, data: Dict[str, Any]) -> None:
        ...
        self.maxFeeForCtAddr: Decimal | None = Decimal(str(data.get('maxFeeForCtAddr'))) if (
            data.get('maxFeeForCtAddr')) else None
        ...
        self.minFeeForCtAddr: Decimal | None = Decimal(str(data.get('minFeeForCtAddr'))) if (
            data.get('minFeeForCtAddr')) else None
